...
public class DesktopFragment extends LocalizeFragment {
	...
	public ImageView obterImagem(final TipoServicoDTO tipoServico) {
		...
		//imageButton.setImageResource(getActivity().getResources().getIdentifier("drawable/img_no_foto", null, getActivity().getPackageName()));
		
		imageView.setImageBitmap(tipoServico.getIcon());
		...
		imageView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(final View view) {
				...
				Bundle b = new Bundle();
				 ...
				 b.putByteArray(IMG_PANEL,tipoServico.getIconPanel());
